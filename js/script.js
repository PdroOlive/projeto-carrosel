...
let card = document.getElementById("icard");
let imageVisa = document.getElementById("image-visa");
let imageElo = document.getElementById("image-elo");
let imageMaster = document.getElementById("image-master");
let valueTot = document.getElementById("container-value");
let containerTotMonth = document.getElementById("container-value-month");
let containerTotWeek = document.getElementById("container-value-week");
let inputCupom = document.getElementById("icupom");
let saleOff = document.getElementById("saleoff");
let inputCVV = document.getElementById("icvv");
let validatedInput = document.getElementById("input-validated");
let inputDate = document.getElementById("idate");
let menuEffect = document.getElementById("progress-card");
let containerCard = document.getElementById("container-input-card");
let pixEffect = document.getElementById("progress-pix");
let containerPix = document.getElementById("container-payment-pix");
let op = document.getElementById("option1");
let inputParcel = document.querySelector("#iparcel");
